...
class ProjectTest < ActiveSupport::TestCase
  ...
  def test_destroying_root_projects_should_clear_data
    ...
    assert_equal 0, Project.connection.select_all("SELECT * FROM projects_trackers WHERE deleted_at IS NOT NULL").count
    assert_equal 0, Project.connection.select_all("SELECT * FROM custom_fields_projects WHERE deleted_at IS NOT NULL").count
